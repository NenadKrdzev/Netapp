...
namespace eCinema.Web.Controllers
{
    public class TicketsController : Controller
    {
      ...
      //  private readonly UserManager<eCinemaUser> _userManager;
        ...
        {
            var allTickets = this._ticketService.GetAllTicket();
            return View(allTickets);
        }

        
        // GET: Tickets to Cart
        public IActionResult AddTicketToCartAsync(Guid? id)
        {
        ...
        public IActionResult AddTicketToCart([Bind("TicketId","Quantity")]AddToShoppingCartDto item)
        {
            ...
            var res=this._ticketService.AddToShoppingCart(item, userId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Create([Bind("Id,TicketName,TicketImage,TicketGenre,TicketDate,TicketPrice")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(Guid id, [Bind("Id,TicketName,TicketImage,TicketGenre,TicketDate,TicketPrice")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
